...
export const SITE_PAGES = [
  ...
  { path: "/rekvizity/", title: "Реквизиты для оплаты", priority: 0.85, changeFrequency: "monthly" as const },
  ...
  { path: "/articles/zakryvayushchie-dokumenty/", title: "Закрывающие документы", priority: 0.75, changeFrequency: "monthly" as const },
  { path: "/articles/naznachenie-platezha/", title: "Назначение платежа", priority: 0.75, changeFrequency: "monthly" as const },
  { path: "/articles/chto-takoe-upd/", title: "Что такое УПД", priority: 0.75, changeFrequency: "monthly" as const },
  { path: "/articles/patent-ili-usn/", title: "Патент или УСН", priority: 0.75, changeFrequency: "monthly" as const },

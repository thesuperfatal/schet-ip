    ...
    <div className="bg-gradient-to-b from-blue-50 to-slate-50">
      <section className="mx-auto max-w-5xl px-4 py-20 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600">
          Счета, акты и договоры в PDF, калькуляторы УСН и НДС — посчитайте налоги и оформите
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            },
            {
              ...
              text: "Простой шаблон в PDF: стороны, предмет, сумма прописью.",
            },
            {
              href: "/nakladnaya/",
              title: "Накладная / УПД",
              text: "Товарная накладная или УПД в PDF для отгрузки.",
            },
            {
              href: "/kp/",
              title: "Коммерческое предложение",
              text: "КП в PDF: позиции, сумма, срок действия предложения.",
            },
            {
              href: "/usn/",
            ...
            },
            {
              ...
              text: "Фикс + 1% свыше 300 тыс. ₽ — итого и сколько откладывать.",
            },
            {
              href: "/nds/",
            ...
            },
            {
              ...
              text: "Дата счёта + отсрочка, дни просрочки и ориентир пеней.",
            },
            {
              href: "/otkryl-ip/",
      ...
      <section className="mx-auto max-w-3xl px-4 pb-12 text-sm leading-relaxed text-slate-700">
        ...
        <p className="mt-3">
          ...
          выставить счёт, акт или договор, посчитать налог УСН и НДС. Всё работает в браузере, без
          регистрации и без отправки документов на сервер.{" "}
